## 1. Engines
- [x] 1.1 Install and record available native/model engines from official sources.
- [x] 1.2 Connect selected engines, test actual legal replies and explicit unavailable/failure behavior.

## 2. Bot platform
- [x] 2.1 Build grouped roster, engine/rating selection, colors, clocks and assistance controls.
- [x] 2.2 Implement server clocks, hints, undo, contextual chat, adaptive targets and crowns without protected regressions.
- [x] 2.3 Verify save/reload, ownership and delayed-response behavior with runnable checks.
