...
Pinned CC0 source → legal catalogue and position index → failing API/history checks → browse and playback → saved study/practice and recognition → local video → PR and local promotion.

- [x] Confirm source license and pin all source files locally.
- [x] Replay and validate every opening; retain reproducible import.
