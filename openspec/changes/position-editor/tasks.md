...
Reference and source → validation and historical boundaries → failing checks → editor and isolated save → native analysis and practice → desktop/mobile video → PR.

- [x] Read source and current official position-setup behavior.
