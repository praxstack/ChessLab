...
function App() {
  ...
  function changePage(next){if(next==='learn')setLesson(null);exerciseSequence.current++;viewSequence.current++;setPage(next);setSelected(null);setFeedback(null);setAutoplay(false);setShowBefore(false);if(next==='library'&&user)refreshGames().catch(err=>setError(err.message));}
