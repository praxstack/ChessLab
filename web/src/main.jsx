...
function App() {
  ...
  const pageTitle=page==='vision'?'Vision':page==='training'?'Puzzles':page==='openings'?'Openings':page==='learn'?'Learn the essentials':page==='puzzles'?'Find the next move':page==='library'?'Your games & studies':mode==='review'?'Game review':'Play bots';
