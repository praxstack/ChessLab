...
function App() {
  ...
  const [saving,setSaving]=useState(false),[gameReport,setGameReport]=useState(undefined),[practiceTarget,setPracticeTarget]=useState(null),[positionDraft,setPositionDraft]=useState(null);
